...
def main():
    ...
    # 3. Add labels, legends, titles, and save your figure to 'exercise7_step2_tagger_selection_stack.png'.
    # ----------------------------------------------------
    # Write your code below:
    
    # TODO: Construct 2-panel tagger-selected stack plot (Linear & Log scale)
