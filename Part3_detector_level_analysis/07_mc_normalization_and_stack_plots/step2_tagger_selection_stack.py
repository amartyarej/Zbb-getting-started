#!/usr/bin/env python3
"""
Exercise 7 — Step 2: Tagger-Selected Stack Plot (ParT MassDec 50% WP)
...
def main():
    ...
    for key in proc_order:
        ...
        # ParT working point selection: ParT MassDec 50% WP
    ...
    # ====================================================
    # TODO: EXERCISE TASK 1 (ParT MassDec 50% WP Selection Stack Plot)
    # ====================================================
    # Task Instructions:
    # 1. Create a 2-panel figure showing the ParT MassDec 50% WP tagger-selected stack plot in Linear Scale (left) and Log Scale (right).
    # 2. Use mass_tag_list and w_tag_list with bins = np.linspace(50, 250, 21).
    # 3. Add axis labels, process legends, titles, and save your figure to 'exercise7_step2_part_selection_stack.png'.
    # ----------------------------------------------------
    # Write your code below:
    
    # TODO: Construct 2-panel ParT MassDec 50% WP tagger-selected stack plot (Linear & Log scale)


    # ====================================================
    # TODO: EXERCISE TASK 2 (GN3X D_bb > 0.60 Selection Stack Plot)
    # ====================================================
    # Task Instructions:
    # 1. Create a 2-panel figure showing the GN3X D_bb > 0.60 tagger-selected stack plot in Linear Scale (left) and Log Scale (right).
    # 2. Use mass_gn3x_list and w_gn3x_list with bins = np.linspace(50, 250, 21).
    # 3. Add axis labels, process legends, titles, and save your figure to 'exercise7_step2_gn3x_dbb_selection_stack.png'.
    # ----------------------------------------------------
    # Write your code below:
    
    # TODO: Construct 2-panel GN3X D_bb > 0.60 tagger-selected stack plot (Linear & Log scale)
