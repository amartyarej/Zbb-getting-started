...
```text
Constituent Arrays (EMPFlow/Truth) ──> Sequential Recombination ──> Multi-Radius Scan ──> Subjet Reclustering
```

In this module, you will analyze a few events of Large Hadron Collider (LHC) $Z \to b\bar{b}$ dataset containing charged and neutral final-state constituent particles:
```text
